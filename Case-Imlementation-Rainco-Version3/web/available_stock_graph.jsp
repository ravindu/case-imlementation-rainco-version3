...
<script src="js/DM_ajax.js"></script>
<script src="js/functions_page.js"></script>
<script src="js/A_test_ajax.js"></script>
  ...
  <div class="wrapper-div">
   ...
   <div class="bucket-menu">
    <ul>
       ...
       <li><a href="available_stock_graph.jsp" class="selected" >Umbrella Priorities</a></li>
    ...
    <div class="middle-parent">
      ...
      <h1>Priority Levels for the Umbrellas</h1>
      <br /> <br />
      
      
      <p>Click on the graph to view umbrella codes and click on each to view the corresponding mould codes</p>
      
      <br /> <br />
       <div style="border:1px;width:500px;height:600px;overflow:auto">
      
      <IMG src="DM_graph" onclick="test_ajax()">

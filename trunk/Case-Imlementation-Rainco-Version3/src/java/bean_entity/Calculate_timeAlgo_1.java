 ...
 *
 * @author Ravindu
 * Calculate remaining total remaining time-fresh moulds
 */
public class Calculate_timeAlgo_1 {
    ...
    /*
     * add all the relevent details to NotComplete_algoBean class.
        ...
        try {
            ...
            { 
                ...
                double hours=Double.valueOf(DF.format(total_hours));
                 ...
                 NCB=new NotComplete_algoBean(Machine, Mould, ReturnQTY,total_kgs,hours);
                 QTY.add(NCB);
            }
        } 
        catch (Exception ex) 
